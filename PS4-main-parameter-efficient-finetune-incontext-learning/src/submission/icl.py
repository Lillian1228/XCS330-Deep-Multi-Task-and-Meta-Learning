...
def get_icl_prompts(
    ...
    **Note**: Be sure to shuffle the support examples and labels 
    ...
    if k > 0:
        ...
        indices = np.random.permutation(indices) # Note 2 - shuffle the order of inputs and targets
        for idx in indices:
            if prompt_mode == "qa":
                ...
                prompt += "article: " + support_inputs[idx] + " summary: " + support_labels[idx] + " "
    ...
    if prompt_mode == "qa":
        ...
        prompt += "article: " + test_input + " summary:"
