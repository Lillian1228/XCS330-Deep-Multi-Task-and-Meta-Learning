...
class MAML:
    ...
    def _inner_loop(self, images, labels, train):
        ...
        for _ in range(self._num_inner_steps):
            ...
            gradients = autograd.grad(inner_loss, parameters.values(), create_graph=train)

            for (i, n) in enumerate(parameters.keys()):
                parameters[n] = parameters[n] - self._inner_lrs[n] * gradients[i]
    ...
    def _outer_step(self, task_batch, train):
        ...
        for task in task_batch:
            ...
            adapted_parameters, accuracy_support, _ = self._inner_loop(images_support, labels_support, train=train)
