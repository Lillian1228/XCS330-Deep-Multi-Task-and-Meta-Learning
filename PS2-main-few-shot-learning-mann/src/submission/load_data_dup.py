...
class DataGenerator(IterableDataset):
    ...
    def _sample(self, sample_fn=None, shuffle_fn=None):
        ...
        support_set = get_images(character_folders, labels, nb_samples=K)
        ...
        #     query_set.append(image_set[(i+1)*K])
        #     support_set+= image_set[i*K : (i+1)*K]
        ...
        image_np = np.asarray(tmp_images).reshape((K+1,N, self.dim_input)) # 784
